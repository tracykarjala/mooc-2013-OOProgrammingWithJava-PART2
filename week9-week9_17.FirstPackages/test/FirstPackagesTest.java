...
public class FirstPackagesTest {
    ...
    public void hasUserInterface() {
        Class clazz = null;
        try {
            clazz = ReflectionUtils.findClass("mooc.ui.mooc.ui.UserInterface");
            //clazz = ReflectionUtils.findClass("mooc.ui.UserInterface");
        } catch (Throwable e) {
            fail("Create package mooc.ui and inside it, create interface mooc.ui.UserInterface:\n\n"
                    + "public interface mooc.ui.UserInterface{\n  \\\\...\n}");
        }

        if (clazz == null) {
            fail("Have you created public interface mooc.ui.UserInterface inside the package mooc.ui?");
        }

        if (!clazz.isInterface()) {
            fail("Are you sure that mooc.ui.UserInterface is an interface?");
        }
        ...
        if (!loytyi) {
            fail("Does the interface mooc.ui.UserInterface have method void update()?");
        }
    }
    ...
    public void hasTextUserInterface() {
        ...
        Class ui = ReflectionUtils.findClass("mooc.ui.mooc.ui.UserInterface");
        ...
        fail("Does the class TextUserInterface implement interface mooc.ui.UserInterface?");
    }
    ...
    public void textUserInterfacePrints() {
        ...
        try {
            ...
            fail("There was an error when executing code. Check what happens when you run code:\n"
                    + "mooc.ui.UserInterface ui = new TextUserInterface();\n"
                    + "ui.update()\n");
        }
    ...
    public void hasApplicationLogic() {
        ...
        Class uiClass = ReflectionUtils.findClass("mooc.ui.mooc.ui.UserInterface");

        Constructor constructor = ReflectionUtils.requireConstructor(sovellusLogiikkaClass, uiClass);
        if (constructor == null) {
            fail("Does the class ApplicationLogic have constructor public ApplicationLogic(mooc.ui.UserInterface ui)?");
        }
    ...
    public void noRedundantVariables() {
        saniteettitarkastus("mooc.logic.ApplicationLogic", 1, "an instance variable of type mooc.ui.UserInterface");
    }
    ...
    public void createApplicationLogicObject() throws IllegalArgumentException, IllegalAccessException {
        ...
        assertTrue("Does the class ApplicationLogic have an instance variable of type mooc.ui.UserInterface?", kentat.length == 1);
        assertTrue("Does the class ApplicationLogic have an instance variable of type mooc.ui.UserInterface?", kentat[0].toString().contains("mooc.ui.UserInterface"));
        ...
        assertFalse("ApplicationLogic's instance variable " + kentat[0].toString().replace("mooc.logic.ApplicationLogic.", "") + " "
                + "null. \nSet the mooc.ui.UserInterface-object given as a parameter in the constructor as this instance variable's value!", kentat[0].get(sovelluslogic) == null);
        ...
        if (executeOutput.length() < output.length() * 3) {
            fail("Is the method update() of interface mooc.ui.UserInterface called as many times as the parameter howManyTimes tells to in the method execute of class ApplicationLogic?");
